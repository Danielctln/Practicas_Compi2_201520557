...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_declarations = 10,              /* declarations  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "INT", "CHAR",
  "COMMA", "SEMICOLON", "$accept", "program", "declarations",
...
#line 1108 "parser.tab.c"
  ...
  case 8: /* id_list: ID  */
#line 67 "parser.y"
       { add_pair((yyvsp[0].str), (yyvsp[-1].str)); (yyval.str) = (yyvsp[-1].str); }
#line 1114 "parser.tab.c"
    break;

  case 9: /* id_list: id_list COMMA ID  */
#line 68 "parser.y"
                       { add_pair((yyvsp[0].str), (yyvsp[-2].str)); (yyval.str) = (yyvsp[-2].str); }
